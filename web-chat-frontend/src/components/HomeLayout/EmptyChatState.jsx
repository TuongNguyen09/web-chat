...
const EmptyChatState = () => (
  <div className="h-full flex flex-col items-center justify-center bg-white dark:bg-[#2a2a2a] text-center p-4">
    <div className="max-w-md">
      ...
      />
      <h1 className="text-3xl md:text-4xl font-semibold text-gray-700 dark:text-gray-200 mb-4">
        WhatsApp Web
      </h1>
